...
//		_img_org_.css("cursor","pointer");
		...
		var _val_w = (setting.renderTo.width() / 1.67);
		var _val_h = (setting.renderTo.height() / 1.67);
		...
		_img_org_.mousemove(function(e){
			...
			_move_y =0-Math.round((document.documentElement.scrollTop+e.clientY) * __h - _val_h);
